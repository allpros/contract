/**
 *  AllProsToken Presale contract
 */

pragma solidity 0.4.15;

import './AllProsToken.sol';
...
contract Presale {
    ...
    AllProsToken public AllProsTokenT;
    ...
    /// @param _token Address of the AllProsToken contract
    function Presale(address _token) {
        require (_token != address(0));
        owner = msg.sender;
        AllProsTokenT = AllProsToken(_token);
    }
    ...
    function () notEnded payable public {
        ...
        AllProsTokenT.transfer(msg.sender, tokensPurchased);
    ...
    function withdrawTokens(address _to) onlyOwner public {
        ...
        ended = true;
        AllProsTokenT.transfer(_to, tokensAvailable);
    }
}
